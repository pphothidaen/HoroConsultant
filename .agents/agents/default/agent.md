...
description: Master Orchestrator & System Director for HoroConsultant. Decomposes tasks into plans/plan.md, coordinates peer debate among domain masters, delegates technical tasks to specialized subagents, and enforces architecture quality.
