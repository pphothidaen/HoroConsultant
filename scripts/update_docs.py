...
# 2. Update ATOMIC_TICKET.md
with open('/Users/kimlenglim/Project/HoroConsultant/ATOMIC_TICKET.md', 'r') as f:
    pt_content = f.read()
...
with open('/Users/kimlenglim/Project/HoroConsultant/ATOMIC_TICKET.md', 'w') as f:
    f.write(pt_content)
