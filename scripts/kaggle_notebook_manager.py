        ...
        "cells": [
            {
                ...
                "source": [
                    ...
                    "subprocess.run([sys.executable, '-m', 'pip', 'install', '-q', '--progress-bar', 'off', '--prefer-binary', 'transformers>=4.40.0,<4.45.0', 'peft>=0.10.0', 'bitsandbytes>=0.43.3', 'datasets>=2.18.0', 'trl>=0.11.0', 'huggingface_hub>=0.25.0', 'accelerate'], check=True)\n",
                    "try:\n",
                    "    import bitsandbytes\n",
