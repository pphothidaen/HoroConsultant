        ...
        "cells": [
            {
                ...
                "source": [
                    ...
                    "        subprocess.run([sys.executable, '-m', 'pip', 'install', '-q', '--prefer-binary', 'torch==2.2.0+cu121', 'torchvision==0.17.0+cu121', '--index-url', 'https://download.pytorch.org/whl/cu121'], check=True)\n",
                    "    else:\n",
