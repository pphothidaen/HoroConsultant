        ...
        "cells": [
            {
                ...
                "source": [
                    ...
                    "all_secrets = [\n",
                    "    'DOPPLER_TOKEN', 'HF_TOKEN', 'HUGGINGFACE_TOKEN', 'GH_TOKEN', 'GITHUB_TOKEN',\n",
                    "    'GOOGLE_AI_STUDIO_API_KEY', 'GOOGLE_AI_STUDIO_API_KEY2', 'GEMINI_API_KEY',\n",
                    "    'APP_SUPABASE_URL', 'APP_SUPABASE_KEY', 'SUPABASE_URL', 'SUPABASE_ANON_KEY',\n",
                    "    'WANDB_KEY', 'KAGGLE_TOKEN', 'KAGGLE_USERNAME', 'TELEGRAM_BOT_TOKEN', 'TELEGRAM_CHAT_ID'\n",
                    "]\n",
                    "try:\n",
