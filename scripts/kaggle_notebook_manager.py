        ...
        "cells": [
            {
                ...
                "source": [
                    ...
                    "subprocess.run([sys.executable, '-m', 'pip', 'install', '-q', '--no-progress-bar', '--prefer-binary', '-r', 'requirements.txt'], check=True)\n",
                    "subprocess.run([sys.executable, '-m', 'pip', 'install', '-q', '--no-progress-bar', '--prefer-binary', 'transformers==4.44.2', 'peft==0.12.0', 'bitsandbytes==0.43.3', 'datasets==2.18.0', 'trl==0.11.0', 'huggingface_hub==0.25.1', 'accelerate==0.33.0'], check=True)\n",
