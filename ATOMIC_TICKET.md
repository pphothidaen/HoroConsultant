...
`atomic_tasks.md` and `ATOMIC_TICKET.md` are the authoritative registries for active ticket status, ownership,
...
| `atomic_tasks.md` | Authoritative task registry mirror and active sprint board | N/A (Maintained in parity with ATOMIC_TICKET.md) |
...
- Maintain `ATOMIC_TICKET.md` as the sole authoritative atomic ticket registry in continuous parity with `atomic_tasks.md`.
