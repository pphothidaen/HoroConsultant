...
> **Document role (2026-08-28):** This file is the domain/product roadmap only. The
> implementation paths below exist in the repository; current ticket status,
> release gates, and evidence are authoritative in [`PROJECT_TASKS.md`](../PROJECT_TASKS.md).
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/tai_yi_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/liu_ren_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/qi_men_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/zi_wei_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/iching_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/liu_yao_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/mei_hua_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/xuan_kong_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/san_he_engine.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `scripts/mian_xiang_vision.py`
...
* **โมดูลปัจจุบัน / ขยายผลต่อ**: `project/core/ze_ji_engine.py`
