...
def test_developer_defaults_to_luna_without_weakening_release_roles() -> None:
    ...
    assert settings["models"]["devops"] == "gpt-5.3-codex-spark"
    assert settings["models"]["code_reviewer"] == "gpt-5.3-codex-spark"
...
def test_developer_catalog_and_generated_mirrors_match_the_source() -> None:
    ...
    assert all("gpt-5.3-codex-spark" not in line for line in developer_lines)
